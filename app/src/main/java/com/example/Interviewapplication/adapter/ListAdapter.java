...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.TaskViewHolder> {
    ...
    CreateBottomSheetFragment.setRefreshListener setRefreshListener;

    public ListAdapter(MainActivity context, List<Task> taskList, CreateBottomSheetFragment.setRefreshListener setRefreshListener) {
